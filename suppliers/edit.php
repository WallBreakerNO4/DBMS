...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if ($_POST['username'] !== $supplier['username']) {
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="username"
                                   value="<?php echo htmlspecialchars($supplier['username']); ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contact_name" name="contact_name" 
                                   value="<?php echo htmlspecialchars($supplier['contact_name']); ?>" required>
                        </div>
